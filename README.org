...
** TODO Read Nixos Installation instructions

*** TODO Find out how sharing a boot volume between specializations works.

** TODO Preform a basic non-gui install with no lvm

** TODO Convert that basic non-gui install to use specializations
